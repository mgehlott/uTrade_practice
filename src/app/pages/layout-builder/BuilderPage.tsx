...
import {KTSVG, toAbsoluteUrl} from '../../../utrade/helpers'
import {getLayoutFromLocalStorage, ILayout, LayoutSetup} from '../../../utrade/layout/core'
        ...
        <div className='card-body d-flex align-items-center py-8'>
          ...
          <div className='ms-6'>
            ...
            <p className='list-unstyled text-gray-600 fw-bold fs-6 p-0 m-0'>
              ...
              <code>src/utrade/layout/core/_LayoutConfig.ts</code> file). Don't forget clear your
